			...
			<table className="w-full font-sans text-sm">
				<thead>
					<tr className="bg-bg-subtle border-b border-border">
						...
						<th className="text-left px-3 py-3 font-medium text-text-subtle hidden md:table-cell">IFRS</th>
						<th className="text-left px-3 py-3 font-medium text-text-subtle hidden md:table-cell">NFRS</th>
